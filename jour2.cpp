...
int main(){
	int reponse = 0;
	int tableau [16][16] = {{104, 240, 147, 246, 123, 175, 372, 71, 116, 230, 260, 118, 202, 270, 277, 292},
	...
	for (int i = 0; i < 16; i++){
		...
		while(!trouve){
			j2 = j1 + 1;
			while(!trouve && j2 < 16){
				if(tableau[i][j1] % tableau[i][j2] == 0){
					dividant = tableau[i][j1];
					diviseur = tableau[i][j2];
					trouve = true;
				}
				if (tableau[i][j2] % tableau[i][j1] == 0){
					dividant = tableau[i][j2];
					diviseur = tableau[i][j1];
					trouve = true;
				}
				j2++;
			}
